...
public class ComplexTest {
    ...
    @Test
    void testEquals(){
        assertEquals(false, Complex.ONE.equals(2));
        assertEquals(false, minusI.equals(Complex.ZERO));
        assertEquals(true, two.equals(two));
    }

    @Test
    void testReal(){
        assertEquals(new Complex(28,0), Complex.real(28));
        assertEquals(new Complex(-6,0), Complex.real(-6));
    ...
    @Test
    void testAdd(){
        assertEquals(new Complex(4,-3), Complex.ONE.add(new Complex(3,-3)));
        assertEquals(new Complex(-7,-3), Complex.ONE.add(new Complex(-8,-3)));
        assertEquals(new Complex(1,4), Complex.ONE.add(new Complex(0,4)));
    }
    ...
    @Test
    void testModulus(){
        assertEquals(Math.sqrt(1), Complex.ONE.modulus());
        assertEquals(Math.sqrt(1), minusI.modulus());
    ...
    @Test
    void testPow(){
        assertEquals(new Complex(-16,-16), new Complex(2,-2).pow(3));
        assertEquals(new Complex (0,0.5), new Complex(0.5,0.5).pow(2));
        assertEquals(new Complex (-7,24),new Complex(-3,-4).pow(2));
        assertEquals(Complex.ONE,new Complex(-3,-4).pow(0));
    }
}